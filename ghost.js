let updateGhostDirections = () => {
  for (let i = 0; i < ghosts.length; i++) {
    ghosts[i].changeRandomDirection();
  }
};

// Call it once every 10 seconds
setInterval(updateGhostDirections, 10000);
...
class Ghost {
  ...
  draw() {
    ...
    // this is for moving then drawing the ghost
